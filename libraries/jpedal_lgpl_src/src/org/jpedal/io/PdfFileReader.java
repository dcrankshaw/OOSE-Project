...
private PdfObject readCompressedStream(int pointer) throws PdfException {
    ...
    /**
       ...
       private int readFirstStartRef() throws PdfException {
           ...
           int pointer = -1;
           int i = 1019;
           StringBuffer startRef = new StringBuffer(10);
    ...
    private String findOffsets() throws PdfSecurityException {
        ...
        while (true) {
            ...
            if (line.indexOf(" obj")!=-1) {
                ...
                if (pointer > -1)
                    storeObjectOffset(Integer.parseInt(line.substring(0,pointer)), i, 1,false);
...
// <start-me>
     ...
     */
    private void storeObjectOffset(int current_number, int current_offset, int current_generation, boolean isEntryCompressed)
    {
