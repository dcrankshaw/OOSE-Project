...
public class JPedalSettings {
    ...
    public static final Integer ALLOW_PAGES_SMALLER_THAN_PAGE_SIZE = new Integer(15);
    
    /**Integer for color to use for background*/
    public static final Integer PAGE_COLOR = new Integer(16);
    
    /**Integer for color of non rendered page background*/
    public static final Integer UNDRAWN_PAGE_COLOR = new Integer(17);
