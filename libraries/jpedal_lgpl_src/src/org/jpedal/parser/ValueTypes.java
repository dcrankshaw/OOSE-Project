...
public class ValueTypes {
    ...
    final public static int PDFData=-18;
    final public static int PDFImages=-19;
    final public static int TextAreas=-20;
    final public static int TextDirections=21;
    final public static int DynamicVectorRenderer=22;
