...
public class PdfStreamDecoderForPrinting extends PdfStreamDecoder {
    ...
    public PdfStreamDecoderForPrinting(PdfObjectReader currentPdfFile, boolean b, PdfLayerList layers, PdfObject resources) {
        super(currentPdfFile, b, layers, resources);
    ...
    public void setObjectValue(int key, Object  obj){
        ...
        if(key==ValueTypes.ObjectStore){
            ...
            current=new ScreenDisplay(this.pageNum,objectStoreStreamRef,true);
