...
public class RotatedTexturePaint implements PdfPaint {
    ...
    public RotatedTexturePaint(boolean isSideways, float[][] rawMatrix, PdfObject patternObj, boolean cacheToTile,
        ...
        //debug=true;
        //debug=patternObj.getObjectRefAsString().equals("12 0 R");
    ...
    public PaintContext createContext(ColorModel cm, Rectangle db, Rectangle2D ub,
        ...
        if(debug){
            ...
            debugG2.drawLine(-1000, 0, 1000, 0);
            debugG2.drawLine(0,-1000,0,1000);
            debugG2.setPaint(Color.CYAN);
            debugG2.fillRect(0, 0, (int)ub.getWidth(), (int)ub.getHeight());
        ...
        if(numberOfRows >1){ //multiple rows
            ...
            if(debug)
                System.out.println("Multiple Rows OffsetX="+offX+" offsetY="+offY);
        ...
        if(debug){
            ...
            try {
            	ImageIO.write(wholeImage,"PNG",new java.io.File("C:/Users/dewy/Desktop/Cases/7533 - Scoob/wholeImage-"+this.patternObj.getObjectRefAsString()+"-"+rect.x+"-"+rect.y+".png"));
                ImageIO.write(img,"PNG",new java.io.File("C:/Users/dewy/Desktop/Cases/7533 - Scoob/Pattern-"+this.patternObj.getObjectRefAsString()+"-"+rect.x+"-"+rect.y+".png"));
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            if(tileImg!=null){
                ...
                try {
                    ImageIO.write(img2,"PNG",new java.io.File("/Users/markee/Desktop/PatternOrig-"+this.patternObj.getObjectRefAsString()
