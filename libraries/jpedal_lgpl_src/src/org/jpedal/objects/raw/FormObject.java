    ...
    public void setTextStreamValue(int id,String value) {
        ...
        switch(id){
	        ...
	        case PdfDictionary.V:
	        	...
	        	break;
	        case PdfDictionary.T:
	        	this.setTextStreamValue(id, value.getBytes());
	        	break;
            default:
                super.setTextStreamValue(id,value);
...
//		4=cmyk
    ...
    public PdfObject duplicate() {
        ...
        //String[]
        newObject.OptString = (OptString==null) ? null : (String[])OptString.clone();
        
        //boolean[]
        newObject.flags = flags==null ? null : (boolean[])flags.clone();
        newObject.Farray=Farray==null ? null : (boolean[])Farray.clone();

        //int[]
        newObject.I = I==null ? null : (int[])I.clone();
        
        //float[]
        newObject.C=C==null ? null : (float[])C.clone();
        newObject.Rect=Rect==null ? null : (float[])Rect.clone();
        newObject.RD=RD==null ? null : (float[])RD.clone();
        newObject.textColor = textColor==null ? null : (float[])textColor.clone();
        ...
        //Object[]
        newObject.Opt=Opt==null ? null : (Object[])Opt.clone();
        newObject.Reference=Reference==null ? null : (Object[])Reference.clone();
        
        //byte[]
        newObject.rawAS=rawAS==null ? null : (byte[])rawAS.clone();
        newObject.rawCert=rawCert==null ? null : (byte[])rawCert.clone();
        newObject.rawContactInfo=rawContactInfo==null ? null : (byte[])rawContactInfo.clone();
        newObject.rawContents=rawContents==null ? null : (byte[])rawContents.clone();
        newObject.rawDA=rawDA==null ? null : (byte[])rawDA.clone();
        newObject.rawDstring=rawDstring==null ? null : (byte[])rawDstring.clone();
        newObject.rawDV=rawDV==null ? null : (byte[])rawDV.clone();
        newObject.rawEOPROPtype=rawEOPROPtype==null ? null : (byte[])rawEOPROPtype.clone();
        
        newObject.rawFilter=rawFilter==null ? null : (byte[])rawFilter.clone();
        newObject.rawFstring=rawFstring==null ? null : (byte[])rawFstring.clone();
        newObject.rawH=rawH==null ? null : (byte[])rawH.clone();
        newObject.rawJS=rawJS==null ? null : (byte[])rawJS.clone();
        newObject.rawLocation=rawLocation==null ? null : (byte[])rawLocation.clone();
        newObject.rawM=rawM==null ? null : (byte[])rawM.clone();
        newObject.rawN=rawN==null ? null : (byte[])rawN.clone();
        newObject.rawNM=rawNM==null ? null : (byte[])rawNM.clone();
        newObject.rawPstring=rawPstring==null ? null : (byte[])rawPstring.clone();
        newObject.rawRC=rawRC==null ? null : (byte[])rawRC.clone();
        newObject.rawReason=rawReason==null ? null : (byte[])rawReason.clone();
        newObject.rawS=rawS==null ? null : (byte[])rawS.clone();
        newObject.rawSubFilter=rawSubFilter==null ? null : (byte[])rawSubFilter.clone();
        newObject.rawSubj=rawSubj==null ? null : (byte[])rawSubj.clone();
        newObject.rawT=rawT==null ? null : (byte[])rawT.clone();
        newObject.rawTM=rawTM==null ? null : (byte[])rawTM.clone();
        newObject.rawTU=rawTU==null ? null : (byte[])rawTU.clone();
        newObject.rawURI=rawURI==null ? null : (byte[])rawURI.clone();
        newObject.rawV=rawV==null ? null : (byte[])rawV.clone();
        newObject.rawX=rawX==null ? null : (byte[])rawX.clone();
    ...
    public void copyInheritedValuesFromParent(FormObject parentObj) {
		...
		//float[]
		if(C==null)
			C = (parentObj.C==null) ? null : (float[])parentObj.C.clone();
		if(Rect==null)
			Rect = (parentObj.Rect==null) ? null : (float[])parentObj.Rect.clone();
        ...
        //boolean[]
        if(flags==null)
        	flags = (parentObj.flags==null) ? null : (boolean[])parentObj.flags.clone();

        //Object[]
        if(Opt==null)
        	Opt = (parentObj.Opt==null) ? null : (Object[])parentObj.Opt.clone();
    ...
    public void setFieldName(String field) {
        ...
        this.setTextStreamValue(PdfDictionary.T,field.getBytes());
    }
...
//		4=cmyk
    ...
    public void overwriteWith(FormObject form) {
        ...
        if (form.flags != null)
            flags = (boolean[])form.flags.clone();
        ...
        if (form.textColor != null)
            textColor = (float[])form.textColor.clone();
        ...
        C=(form.C==null) ? null : (float[])form.C.clone();

        F=form.F;
        Ff=form.Ff;
        Opt=(form.Opt==null) ? null : (Object[])form.Opt.clone();
    	Q = form.Q;
    	MaxLen=form.MaxLen;
    	FT=form.FT;
        rawAS=(form.rawAS==null) ? null : (byte[])form.rawAS.clone();
    	rawDA=(form.rawDA==null) ? null : (byte[])form.rawDA.clone();
        rawDV=(form.rawDV==null) ? null : (byte[])form.rawDV.clone();
    	rawJS=(form.rawJS==null) ? null : (byte[])form.rawJS.clone();
    	rawNM=(form.rawNM==null) ? null : (byte[])form.rawNM.clone();
    	rawTM=(form.rawTM==null) ? null : (byte[])form.rawTM.clone();
    	rawTU=(form.rawTU==null) ? null : (byte[])form.rawTU.clone();
    	rawV=(form.rawV==null) ? null : (byte[])form.rawV.clone();
    	
    	//copy fieldname
   		T=form.T;
   		rawT=(form.rawT==null) ? null : (byte[])form.rawT.clone();
    	
    	Rect=(form.Rect==null) ? null : (float[])form.Rect.clone();
...
//	}
	...
	public String getTextString() {
		...
		if(textString==null && getTextStreamValue(PdfDictionary.DV)!=null)
			...
			if(textString!=null)
				textString = MEUtils.replaceAll(textString,"\r", "\n").trim();
			else
				textString = "";
