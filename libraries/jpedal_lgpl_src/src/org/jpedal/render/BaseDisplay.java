...
public class BaseDisplay implements DynamicVectorRenderer {
    ...
    void renderEmbeddedText(int text_fill_type, Object rawglyph, int glyphType,
        ...
        if (glyph != null) {
            ...
            if (lineWidth != 0) {
                g2.setStroke(new BasicStroke((float)(lineWidth*g2.getTransform().getScaleX())));
            }
    ...
    public void drawEmbeddedText(float[][] Trm, int fontSize, PdfGlyph embeddedGlyph, Object javaGlyph, int type, GraphicsState gs, AffineTransform at, String glyf, PdfFont currentFontData) {
	//throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    public void setValue(int key,int i) {
        //used by HTML to limit dp, set font handling options,etc
    }
