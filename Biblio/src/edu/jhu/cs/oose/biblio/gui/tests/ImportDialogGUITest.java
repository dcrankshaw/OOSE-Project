...
public class ImportDialogGUITest {
	...
	public static void main(String[] args) {
		try
		{
			...
			FileMetadata file1 = new FileMetadata(new Date(), 0, path1, new HashSet<Tag>(), FileTypes.PDF);
			files.add(file1);
			String path2 = "/Users/Daniel/oose_proj/OOSE-Project/testfiles/test2.pdf";
			FileMetadata file2 = new FileMetadata(new Date(), 0, path2, new HashSet<Tag>(), FileTypes.PDF);
			files.add(file2);
