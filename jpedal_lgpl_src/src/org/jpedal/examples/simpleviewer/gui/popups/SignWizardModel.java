...
{	
	...
	private class PFXPanel extends JPanel 
	{
		...
		private void init() throws Exception
		{
			...
			keyFileLabel.setFont( new java.awt.Font( "Dialog", 1, 14 ) );
...
//			inputPanel.add(new JSeparator(SwingConstants.HORIZONTAL), c);
			...
			passwordLabel.setFont(new java.awt.Font( "Dialog", 1, 14 ));
			c.fill = GridBagConstraints.HORIZONTAL; 
			c.gridx = 0;
			c.gridy = ++y;
	...
	{		
		...
		private void init()
		{
			...
			keyStoreLabel.setFont( new java.awt.Font( "Dialog", 1, 14 ) );
...
//					chooser.addChoosableFileFilter(new FileFilterer(keystore, "*.*")); 
			...
			passwordKeyStoreLabel.setFont(new java.awt.Font( "Dialog", 1, 14 ));
			c = new GridBagConstraints();
			c.fill = GridBagConstraints.HORIZONTAL; 
			c.gridx = 0;
			c.gridy = 2;
...
//			//Alias
			...
			aliasNameLabel.setFont( new java.awt.Font( "Dialog", 1, 14 ) );
			c = new GridBagConstraints();
			c.fill = GridBagConstraints.HORIZONTAL; 
			c.gridx = 0;
			c.gridy = 5;
			...
			aliasPasswordLabel.setFont( new java.awt.Font( "Dialog", 1, 14 ) );
			c = new GridBagConstraints();
			c.fill = GridBagConstraints.HORIZONTAL; 
			c.gridx = 0;
			c.gridy = 7;
    ...
    private class CommonPanel extends JPanel
	{
		...
		private void init()
		{
			...
			reasonLabel.setFont(new java.awt.Font( "Dialog", 1, 14 ));
			c.anchor = GridBagConstraints.FIRST_LINE_START; //Has no effect
			c.fill = GridBagConstraints.HORIZONTAL; 
			c.gridx = c.gridy = 0;
			c.insets = new Insets(10,0,0,0);
			...
			outputFileLabel.setFont(new java.awt.Font( "Dialog", 1, 14 ));
			c = new GridBagConstraints();
			c.fill = GridBagConstraints.HORIZONTAL; 
			c.gridx = 0;
			c.gridy = 5;
	 ...
	 */
	private class PanelTemplate extends JPanel
	{
