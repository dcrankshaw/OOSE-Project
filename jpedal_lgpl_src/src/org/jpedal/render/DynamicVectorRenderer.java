...
public interface DynamicVectorRenderer  {
	...
	public abstract void drawShape(Shape currentShape,GraphicsState currentGraphicsState);
	...
	public abstract void drawEmbeddedText(float[][] Trm, int fontSize,
			...
			GraphicsState gs, AffineTransform at, String glyf, PdfFont currentFontData);
    ...
    void setValue(int maxNumberOfDecimalPlaces, int i);

    //generic method used by HTML for getting values
    public int getValue(int fontMode);

    BufferedImage getLastImageRenderer();

    void setBooleanValue(int includeJSFontResizingCode, boolean b);
}
